...
namespace Engine.Factories
{
    public static class TraderFactory
    {
        ...
        static TraderFactory() {
            ...
            susan.AddItemToInventory(ItemFactory.CreateShopItem(1001));
            Trader farmerTed = new Trader("Farmer Ted");
            farmerTed.AddItemToInventory(ItemFactory.CreateShopItem(1001));
            Trader peteTheHerbalist = new Trader("Pete the Herbalist");
            peteTheHerbalist.AddItemToInventory(ItemFactory.CreateShopItem(1001));
